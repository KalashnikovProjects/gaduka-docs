...
.. code-block:: python 
    ...
    результат = разделить_строку(["Привет Мир!", "Ещё раз привет Мир!"]) # "Привет Мир! Ещё раз привет Мир!"
    
    результат = разделить_строку(["Привет Мир!", "Ещё раз привет Мир!"], соединитель=" -= ") # "Привет Мир! -= Ещё раз привет Мир!"
